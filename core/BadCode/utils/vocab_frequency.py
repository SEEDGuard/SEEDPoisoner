...
def generate_vocabulary_frequency(input_path: str) -> str:
    ...
    for m in python_match_words:
        match_word = m
        # output_path = f"core/BadCode/outputs/vocab_output/nl_code_tokens_split_matching_{match_word}.txt"
        output_path = f"core/BadCode/outputs/vocab_output/nl_code_tokens_split_matching_file.txt"
