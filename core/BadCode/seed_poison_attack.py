...
from core.BadCode.utils.attack_util import get_parser, gen_trigger, insert_trigger, remove_comments_and_docstrings
...
def start_poison_operation(input_file: str, output_dir: str):
    ...
    print("I am old path for vocab",vocab_hashmap_path)
    vocab_hashmap_path: str = "core/BadCode/outputs/vocab_output"
    print("I am new path for vocab",vocab_hashmap_path)
